...
void renderQuad()
{
    if (quadVAO == 0)
    {
        ...
        tangent2.x = f * (deltaUV2.y * edge1.x - deltaUV1.x * edge2.x);
        tangent2.y = f * (deltaUV2.y * edge1.y - deltaUV1.x * edge2.y);
        tangent2.z = f * (deltaUV2.y * edge1.z - deltaUV1.x * edge2.z);
