...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("resources/wood.png"); // note that we're loading the texture as an SRGB texture
    unsigned int containerTexture = loadTexture("resources/brickwall.jpg"); // note that we're loading the texture as an SRGB texture
